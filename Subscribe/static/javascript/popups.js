...
for (var i in cossac) {
	...
	cossacul.append('\
		<li>\
			<div class="proPic" style="background-image: url(../../static/images/cossac/'+cossacn.img+');background-size: cover;"></div>\
			<div class="info">\
...
for (var i in spons) {
	...
	sponsul.append('\
		<li>\
			<div class="proPic" style="background-image: url(../../static/images/sponsors/'+sponsor.logo+')"></div>\
			<div class="info">\
